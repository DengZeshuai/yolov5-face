...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_folder', default='/mnt/cephfs/dataset/widerface/WIDER_val/images', type=str, help='dataset path')
    parser.add_argument('--folder_pict', default='/mnt/cephfs/home/dengzeshuai/data/Detection/widerface/wider_val.txt', type=str, help='folder_pict')
