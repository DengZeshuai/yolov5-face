...
CUDA_VISIBLE_DEVICES="0,1" python train.py --data data/widerface.yaml --cfg models/yolov5l-e-patch.yaml --weights /mnt/cephfs/home/dengzeshuai/code/Detection/CodeDetection/yolov5_obb/pretrain/v5le-coco-patch.pt --name yolov5le_patch_coco_pre_p800b64 --batch-size 64 --workers 8
